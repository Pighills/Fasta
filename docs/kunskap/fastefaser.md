...
| R11 | Bensalem J m.fl. Intermittent time-restricted eating may increase autophagic flux in humans: an exploratory analysis. *J Physiol* 2025. doi:10.1113/JP287938 · Bensalem J m.fl. Human autophagy measurement: an underappreciated barrier to translation. *Trends Mol Med* 2021 · https://pubmed.ncbi.nlm.nih.gov/34629294/ | S / Ö | Sammanfattning läst via PubMed 2026-09-24 (PMID 40345145; *J Physiol* 2025;603(10):3019–3032): 121 personer med fetma, randomiserade till vanlig vård, kaloribegränsning eller periodisk fasta + tidsbegränsat ätande i 6 månader. Efter 6 månader skilde sig förändringen mellan fastegruppen och kontrollgruppen (P = 0,04, efterhandsanalys), delvis för att autofagin *minskade* i kontrollgruppen; ingen signifikant ökning inom fastegruppen. Författarna: fler studier krävs. Stöder de försiktiga texterna. |
...
| R15 | Chen YE, Tsai HL, Tu YK, Chen LW. Effects of timing and eating duration of time restricted eating on metabolic outcomes: systematic review and network meta-analysis. *BMJ Medicine* 2026;5:e001071. doi:10.1136/bmjmed-2024-001071 · https://bmjmedicine.bmj.com/content/5/1/e001071 | SÖ (41 RCT) | Sammanfattning läst via PubMed 2026-09-25 (PMID 41586347): tidigt ätfönster (sista målet före kl. 17) gav 1,15 kg större viktnedgång och lägre fasteinsulin än sent (efter kl. 19), hög evidenssäkerhet; ätfönstrets längd gav inkonsekventa resultat. Stöder texten i schema.16:8. |
