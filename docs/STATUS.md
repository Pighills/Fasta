...
## Pågår
- **Session 8b – pausen** (2026-09-26, cache fasta-v35, gren `fix-pausen`, ej publicerad). H1, H2, M4 i `docs/fixplan.md`. Inget nytt dataformat.
...
## Nästa steg
0. Förhandsvisa/publicera session 8b. Sedan steg 3 i fixplanen: K1 + H3 + M6 + L13 (fältkontroll).
